...
<body class="landing-page sidebar-collapse">
  ...
  <div class="wrapper">
    <div class="page-header page-header-small">
      <div class="page-header-image" data-parallax="true" style="background-image: url('{{ url('assets/img/bg6.jpg'); }}">
      </div>
    ...
    <div class="section section-about-us">
      <div class="container">
        ...
        <div class="section-story-overview">
          <div class="row">
            <div class="col-md-6">
              <div class="image-container image-left" style="background-image: url('{{ url('assets/img/login.jpg') }}">
              ...
              <div class="image-container" style="background-image: url('{{ url('assets/img/bg3.jpg')}}"></div>
            </div>
            <div class="col-md-5">
              <!-- First image on the right side, above the article -->
              <div class="image-container image-right" style="background-image: url('{{ url('assets/img/bg1.jpg')}}"></div>
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="team-player">
                <img src="{{ url('assets/img/avatar.jpg') }}" alt="Thumbnail Image" class="rounded-circle img-fluid img-raised">
            ...
            <div class="col-md-4">
              <div class="team-player">
                <img src="{{ url('assets/img/ryan.jpg') }}" alt="Thumbnail Image" class="rounded-circle img-fluid img-raised">
            ...
            <div class="col-md-4">
              <div class="team-player">
                <img src="{{ url('assets/img/eva.jpg') }}" alt="Thumbnail Image" class="rounded-circle img-fluid img-raised">
