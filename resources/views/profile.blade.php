    ...
    <div class="page-header clear-filter page-header-small" filter-color="orange">
      ...
      <div class="container">
        <div class="photo-container">
          <img src="{{ url('assets/img/ryan.jpg') }}" alt="">
        </div>
          ...
          <div class="tab-content gallery">
            <div class="tab-pane active" id="home" role="tabpanel">
              <div class="col-md-10 ml-auto mr-auto">
                <div class="row collections">
                  <div class="col-md-6">
                    <img src="{{ url('assets/img/bg1.jpg') }}" alt="" class="img-raised">
                    <img src="{{ url('assets/img/bg3.jpg') }}" alt="" class="img-raised">
                  </div>
                  <div class="col-md-6">
                    <img src="{{ url('assets/img/bg8.jpg') }}" alt="" class="img-raised">
                    <img src="{{ url('assets/img/bg7.jpg') }}" alt="" class="img-raised">
                  </div>
                </div>
              </div>
            </div>
            <div class="tab-pane" id="profile" role="tabpanel">
              <div class="col-md-10 ml-auto mr-auto">
                <div class="row collections">
                  <div class="col-md-6">
                    <img src="{{ url('assets/img/bg6.jpg') }}" class="img-raised">
                    <img src="{{ url('assets/img/bg11.jpg') }}" alt="" class="img-raised">
                  </div>
                  <div class="col-md-6">
                    <img src="{{ url('assets/img/bg7.jpg') }}" alt="" class="img-raised">
                    <img src="{{ url('assets/img/bg8.jpg') }}" alt="" class="img-raised">
